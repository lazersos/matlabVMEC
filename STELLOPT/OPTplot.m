...
handles.chi_types={'ASPECT','BETA','CURTOR','EXTCUR','SEPARATRIX',...
    'PHIEDGE','RBTOR','R0','Z0','B0','VOLUME','WP','KAPPA', 'KAPPA_AVG',...
...
switch stemp
    ...
    case{'Chi-Squared'}
        ...
        ylabel('Total \chi^2');
        title('TOTAL CHISQ');
    case{'CURTOR_chisq','VOLUME_chisq','BETA_chisq','ASPECT_chisq','KAPPA_chisq', 'KAPPA_AVG_chisq',...
    ...
    case{'TXPORT_chisq','B_PROBES_chisq','FLUXLOOPS_chisq',...
            ...
            'BOOTSTRAP_chisq','DKES','DKES_ERDIFF',...
